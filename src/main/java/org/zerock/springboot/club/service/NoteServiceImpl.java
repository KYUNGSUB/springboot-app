...
import org.zerock.springboot.club.repository.NoteRepository;
...
public class NoteServiceImpl implements Noteservice {
    ...
    @Override
    public List<NoteDTO> getAllWithWriter(Long writerMid) {
        List<Note> noteList = noteRepository.getList(writerMid);
