...
import org.zerock.springboot.club.service.Noteservice;
...
public class NoteController {
    ...
    public ResponseEntity<List<NoteDTO>> getList(Long mid){
        log.info("-----------getList-------------------------------");
        log.info(mid);
        return new ResponseEntity<>(noteservice.getAllWithWriter(mid), HttpStatus.OK);
    }
